...
void LevelManager::LoadLevels() {
    ...
    for (int lvl = 1; lvl <= totalLevels; ++lvl) {
        LevelData level;
        level.backgroundImage = "C:/Shawarma/CHAO0606/Shawarma/Resources/Image/background/restaurant.png";
        ...
        for (int i = 0; i < custCount; ++i) {
            ...
            int imgIdx = i % 6 + 1;
            cust.customerImage = "C:/Shawarma/CHAO0606/Shawarma/Resources/Image/Customer/customer" + std::to_string(imgIdx) + ".png";
            ...
            if (lvl <= 5) {
                ...
                if (i < custCount/2) {
                    ...
                    cust.foodIcon = "C:/Shawarma/CHAO0606/Shawarma/Resources/Image/Food/FrenchFries.png";
                } else {
                    cust.foodRequest = "Roll";
                    cust.foodIcon = "C:/Shawarma/CHAO0606/Shawarma/Resources/Image/Food/roll.png";
                }
                // 無 requiredToppings
            }
            ...
            // 16-20 關：新增汽水與可樂訂單
                ...
                if (rem == 0) {
                    ...
                    cust.foodIcon = "C:/Shawarma/CHAO0606/Shawarma/Resources/Image/Food/cup_soda_full.png";
                } else if (rem == 1) {
                    cust.foodRequest = "Cola";
                    cust.foodIcon = "C:/Shawarma/CHAO0606/Shawarma/Resources/Image/Food/cup_cola_full.png";
                } else if (rem == 2) {
                    cust.foodRequest = "FrenchFries";
                    cust.foodIcon = "C:/Shawarma/CHAO0606/Shawarma/Resources/Image/Food/FrenchFries.png";
                } else {
            ...
            // 21-24 關：新增果汁
                ...
                if (rem == 0) {
                    ...
                    cust.foodIcon = "C:/Shawarma/CHAO0606/Shawarma/Resources/Image/Food/juice.png";
                } else if (rem == 1) {
                    cust.foodRequest = "Soda";
                    cust.foodIcon = "C:/Shawarma/CHAO0606/Shawarma/Resources/Image/Food/cup_soda_full.png";
                } else if (rem == 2) {
            ...
            // 25-30 關：客製化卷餅
                ...
                cust.foodIcon = "C:/Shawarma/CHAO0606/Shawarma/Resources/Image/Food/" + customIcons[typeIdx];
            }
